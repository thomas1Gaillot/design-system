                    ...
                    <div className="flex justify-center">
                        <a className="inline-flex items-center gap-x-2 bg-white border border-gray-200 text-sm text-gray-800 p-1 ps-3 rounded-full transition hover:border-gray-300 focus:outline-none focus:border-gray-300 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-200 dark:hover:border-neutral-600 dark:focus:border-neutral-600"
                           href="/compositions/timeline">
                            ...
                            <span
                                className="py-1.5 px-2.5 inline-flex justify-center items-center gap-x-2 rounded-full bg-gray-200 font-semibold text-sm text-gray-600 dark:bg-neutral-700 dark:text-neutral-400">
              ...
              d="m9 18 6-6-6-6"/></svg>
                    ...
                    <div className="mt-5 max-w-2xl text-center mx-auto">
                        <h1 className="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-neutral-200">
                            ...
                            {" "}
                            <span
                                className="bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent">Effortlessly</span>
                        </h1>
                    </div>

                    <div className="mt-5 max-w-3xl text-center mx-auto">
                        <p className="text-lg text-gray-600 dark:text-neutral-400">Our design system based on <strong>shadcn-ui</strong> empowers developers and designers to rapidly create beautiful and accessible interfaces. Copy, paste, and customize components to fit your vision without sacrificing flexibility.</p>
                    </div>
                    ...
                    <div className="mt-8 gap-3 flex justify-center">
                        ...
                        <button type="button"
                            ...
                            $ npm i shadcn-ui
                            <span
                                className="flex justify-center items-center bg-gray-200 rounded-md size-7 dark:bg-neutral-700 dark:text-neutral-400">
          <svg className="shrink-0 size-4 group-hover:rotate-6 transition" xmlns="http://www.w3.org/2000/svg" width="24"
              ...
              d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/></svg>
                    ...
                    <div className="mt-5 flex justify-center items-center gap-x-1 sm:gap-x-3">
                        ...
                        <svg className="size-5 text-gray-300 dark:text-neutral-600" width="16" height="16"
